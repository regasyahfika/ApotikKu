...
<div class="right_col" role="main">
	<div class="">
		...
		<div class="row">
					...
					<div class="x_content">
						...
						<table class="table table-bordered table-hover">
							...
							<tbody>
								...
								<td>
								<?php echo $data['kd_supplier'];?></td>
								<td>
								<?php echo $data['nm_supplier'];?></td>
								<td>
								<?php echo $data['alamat'];?></td>
								<td>
								<?php echo $data['telp'];?></td>
								<td>
								<?php echo $data['email'];?></td>
								<td><a href="<?php echo $admin_url; ?>supplier/form_edit.php?kd_supplier=<?php echo $data['kd_supplier'];?>">
								<button class="btn btn-success btn-sm">
									<i class="fa fa-edit"></i>
								</button></a>
								
								<a href="<?php echo $admin_url; ?>supplier/hapus.php?kd_supplier=<?php echo $data['kd_supplier'];?>" onClick="return confirm('Anda yakin ingin menghapus data ini?')">
			...
			<div class="col-xs-8">
				<a href="<?php echo $admin_url; ?>supplier/form_tambah.php">
