    ...
    <div class="content">
    	<div class="image group">
				<div class="grid images_3_of_1">
					<img src="../assets/images/buah-pepaya.jpg" alt="" />
				</div>
				<div class="grid news_desc">
					<h3>Buah Pepaya </h3>
					<h4>Posted on Jan 13th, 2017 by <span><a href="#">Rega Syahfika</a></span></h4>
					<p>Pepaya, atau Carica papaya (nama latin), hampir semua orang mengenal buah yang satu ini. Buah yang banyak tumbuh di daerah tropis ini memiliki banyak manfaat. Mulai dari buahnya yang masih muda dan daunnya, dimanfaatkan sebagai bahan masakan atau jamu, serta daging buahnya yang masak dapat langsung dikonsumsi atau sebagai campuran membuat koktail atau es buah. Tahukah kamu, buah pepaya juga memiliki banyak manfaat bagi kesehatan yang tidak banyak diketahui oleh masyarakat. <a href="#" title="more">[....]</a></p>
			   </div>
		   </div>	
		   <div class="image group">
				<div class="grid images_3_of_1">
		   ...
		   <div class="image group">
				...
				<div class="grid news_desc">
					<h3>Buah Pepaya </h3>
					<h4>Posted on Jan 1st, 2017 by <span><a href="#">Rega Syahfika</a></span></h4>
					<p>Pepaya, atau Carica papaya (nama latin), hampir semua orang mengenal buah yang satu ini. Buah yang banyak tumbuh di daerah tropis ini memiliki banyak manfaat. Mulai dari buahnya yang masih muda dan daunnya, dimanfaatkan sebagai bahan masakan atau jamu, serta daging buahnya yang masak dapat langsung dikonsumsi atau sebagai campuran membuat koktail atau es buah. Tahukah kamu, buah pepaya juga memiliki banyak manfaat bagi kesehatan yang tidak banyak diketahui oleh masyarakat. <a href="#" title="more">[....]</a></p>
			   </div>
		   </div>
