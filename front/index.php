							...
							?>
			                    	<div id="slide-1" class="slide">			                    
									 <div class="slider-img">
							             ...
							             <a href="input.php?input=add&id=<?php echo $data['Id_Produk']; ?>&harga=<?php echo $data['Harga_Produk']; ?>" class="button">Shop Now</a>
					                   </div>			               
									  <div class="clear"></div>				
				                  </div>	
								<?php } ?>	
					...
					<div class="price-details">
				       <div class="price-number">
							<p><span class="rupees">Rp. <?php echo $data['Harga_Produk'];?></span></p>
					       		...
					       		<div class="add-cart">								
									<h4><a href="input.php?input=add&id=<?php echo $data['Id_Produk']; ?>&harga=<?php echo $data['Harga_Produk']; ?>" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to Cart</a></h4>
							     </div>
							 <div class="clear"></div>
					</div>
